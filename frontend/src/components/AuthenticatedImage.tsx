...
/**
 * Component to display authenticated screenshot images
  ...
  ({ screenshotId, alt, className = "", onError, priority = false }) => {
    ...
    useEffect(() => {
      ...
      const observer = new IntersectionObserver(
        ...
        {
          rootMargin: "200px", // Load earlier to prepare images
          threshold: 0.01,
        }
      );
    ...
    useEffect(() => {
      ...
      return () => {
        mounted = false;
        // Note: Don't revoke blob URL here - let RequestQueue manage it
        // to prevent issues when navigating back to cached pages
      };
    }, [screenshotId, shouldLoad, onError]);
